...
class CCAvenueWebViewPageForPayEMI extends StatefulWidget {
  String initiateUrl;
  double amount;
  String orderid;

  CCAvenueWebViewPageForPayEMI(this.initiateUrl, this.amount, this.orderid);

  @override
  _CCAvenueWebViewPageForPayEMIState createState() =>
      _CCAvenueWebViewPageForPayEMIState();
}

class _CCAvenueWebViewPageForPayEMIState
    extends State<CCAvenueWebViewPageForPayEMI> {
      ...
      if (parts.length == 2) {
        ...
        if (status == 'success') {
          ...
          await Navigator.pushReplacement(context, MaterialPageRoute(
            builder: (context) {
              return ThankuPayment(widget.amount, widget.orderid,
