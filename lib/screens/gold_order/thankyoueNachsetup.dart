...
class ThankuForeNachsetup extends StatefulWidget {
  String pagename;
  ThankuForeNachsetup(this.pagename);

  State createState() => ThankuForeNachsetupState();
}

class ThankuForeNachsetupState extends State<ThankuForeNachsetup> {
  @override
  void dispose() {
    ...
    return Scaffold(
        ...
        title: Row(
          ...
          children: [
            GestureDetector(
              ...
              child: Row(
                children: [
                  'Thank You For eNach Setup'.introTitleText(context),
                ],
              ).marginOnly(top: 10),
            ),
          ],
      ...
      body: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(
            "eNach setup successful! We're excited to fulfill your order. Thank you for your business!",
            style: TextStyle(
          ...
          ButtonDesign(
              ...
              child: widget.pagename == "EMI"
                  ? 'Back Home'
                  : "Back My Order List".buttoText())
        ]),
      ),
    );
  }
